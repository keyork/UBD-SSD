...
parser.add_argument(
    "--resume",
    default="./weights_ours/1e-4_train/ssd300_VOC_2200.pth",
    type=str,
    help="Checkpoint state_dict file to resume training from",
)
parser.add_argument(
    "--start_iter", default=2201, type=int, help="Resume training at this iter"
)
parser.add_argument(
    "--num_workers", default=16, type=int, help="Number of workers used in dataloading"
)
parser.add_argument(
...
def train():
    ...
    for iteration in range(args.start_iter, cfg["max_iter"]):
        ...
        if iteration % 10 == 0:
            ...
            print(
                "iter " + repr(iteration) + " || Loss: %.4f ||" % (average_loss / 10),
                end=" ",
            )
            average_loss = 0
        ...
        if iteration != 0 and iteration % 100 == 0:
            ...
            torch.save(
                ssd_net.state_dict(),
                "weights_ours/ssd300_VOC_" + repr(iteration) + ".pth",
            )
